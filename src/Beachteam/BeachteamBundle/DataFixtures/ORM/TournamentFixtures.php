...
class TournamentFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $tournament1->setTournamenttype('Belgian Beach Volley');
        ...
        $tournament2->setTournamenttype('Belgian Beach Volley');
        ...
        $tournament3->setTournamenttype('Belgian Beach Volley');
        ...
        $tournament4->setTournamenttype('Belgian Beach Volley');
        ...
        $tournament5->setTournamenttype('Belgian Beach Volley');
        ...
        $tournament6->setTournamenttype('Belgian Beach Volley');
        ...
        $tournament7->setTournamenttype('Belgian Beach Volley');
        ...
        $tournament8->setTournamenttype('Belgian Beach Volley');
        ...
        $tournament9->setTournamenttype('Belgian Beach Volley');
